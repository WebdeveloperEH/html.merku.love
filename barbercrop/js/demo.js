                  ...
                  !(function (t) {
                    if ("object" === o(t)) {
                      var n = t.delay,
                        ...
                        s = 0,
                        u = 0,
                        m = window.innerHeight - 108;
                      setTimeout(function () {
                        var t;
                        c.classList.add("mdp-float"),
                          c.classList.add("mdp-float-init"),
                          l.classList.add("mdp-float-btn"),
                          (l.href =
                            ((t = i.length > 0 ? "-".concat(i) : ""),
                            "https://1.envato.market/" + p() + t)),
                          (l.target = "_blank"),
                          (l.innerHTML =
                          ...
                          c.appendChild(l),
                          (c.style.top = "".concat(
                            window.scrollY + window.innerHeight - 108,
                            "px"
                          )),
                          document.body.appendChild(c),
                          setTimeout(function () {
                            c.classList.remove("mdp-float-init"),
                              c.classList.remove("mdp-float-inertia");
                          }, 1001),
                          "iframe" === r &&
                            ...
                            (function (t, o, n, e) {
                              ...
                              if (
                                (i.classList.add("mdp-float-popup"),
                                "".length > 0)
                              ) {
                                var r = document.createElement("h4");
                                r.classList.add("mdp-float-h"),
                                  (r.innerHTML = ""),
                                  i.appendChild(r);
                              }
                              var l = document.createElement("p");
                              l.classList.add("mdp-float-msg"),
                                (l.innerHTML = o),
                                i.appendChild(l);
                              var f = document.createElement("a");
                              f.classList.add("mdp-float-action"),
                                (f.href = e),
                                (f.target = "_blank"),
                                (f.rel = "noreferrer noopener"),
                                (f.innerHTML = "<span>".concat(
                                  "Open without iframe",
                                  "</span>"
                                )),
                                i.appendChild(f),
                              ...
                              "Some features of ".concat(
                                ...
                                " may not work correctly inside an iframe."
                              ),
                              0,
                        ...
                        setInterval(function () {
                          var t = Date.now() - f;
                          c.classList.remove("mdp-float-slow"),
                            c.classList.remove("mdp-float-inertia"),
                            /*!catMouseOver &&*/
                            t - a > 2e3 &&
                              t - a < 2999 &&
                              ((m =
                                t > n + 2021 && Math.abs(s - u) < 500
                                  ? u + window.innerHeight - 2 * c.offsetHeight
                                  : u + window.innerHeight > c.offsetTop
                                  ? u +
                                    window.innerHeight -
                                    1.5 * c.offsetHeight
                                  : u +
                                    window.innerHeight -
                                    2.5 * c.offsetHeight),
                              (c.style.top = "".concat(m, "px")),
                              setTimeout(function () {
                                c.classList.add("mdp-float-inertia"),
                                  (c.style.top = "".concat(
                                    u + window.innerHeight - 2 * c.offsetHeight,
                                    "px"
                                  ));
                        ...
                        window.addEventListener("scroll", function (t) {
                          (a = t.timeStamp),
                            (u = window.scrollY),
                            c.classList.add("mdp-float-slow"),
                            (m = u + window.innerHeight - 2 * c.offsetHeight),
                            (c.style.top = "".concat(m, "px"));
                        }),
                        c.addEventListener("mouseenter", function () {
                          c.style.top = "".concat(
                            u + c.getBoundingClientRect().top,
                            "px"
                          );
                        }),
                    ...
                    function p() {
                      ...
                      return (
                        "start" === e &&
                          (t = window.location.hostname.split(".")[0]),
                        "end" === e &&
                          (t =
